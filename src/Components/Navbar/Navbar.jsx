          ...
          <div className="flex justify-between items-center gap-4">
            <div className="relative group hidden sm:block ">
              <input
                type="text "
                placeholder="Search"
                className="w-[200px] sm:-[200px] group-hover:w-[300px] 
      ...
      <div className="flex justify-center">
        <ul className="sm:flex hidden item-center gap-4">
          {Menu.map((data) => (
            <li
              key={data.id}
              className="inline-block px-4 hover:text-primary duration-200 py-1"
            >
              ...
              <ul>
                {DropdownLinks.map((data) => (
                  <li key={data.id}>
                    <a
                      href={data.link}
                      className="block w-full rounded-md p-2 hover:bg-primary/20 duration-200 whitespace-nowrap"
                    >
                      {data.name}
                    </a>
                  </li>
